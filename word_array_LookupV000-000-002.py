...
# Output file:
# Notes: This next version builds on V000-000-001; we need to now be able to lookup a 
#        named entity, non-ticker, word from the official company name table that tend to
#        accompany the brand name with ".com"
#        In this version, we will look for 'amazon' where the match variable is 'Amazon.com, Inc.'. 
#        
...
def main():
    ...
    company_table_data = {
        'company': ['Microsoft Corporation', 'NVIDIA Corporation', 'Amazon.com, Inc.', 'Apple Inc.','JPMorgan Chase & Co.'],
        'stand-alone': [False, False, False, False, False]
    }
