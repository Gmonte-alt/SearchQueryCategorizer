...
# Version file: V001-000-0011 #    Update with next iteration
...
#
#         --note: Found error around two word company names. This version resolves the errors around
#               searches such as "microsoft news", "omnicell stock", "amazon stock"
#               My method will be to edit the check_context function to fork into two paths:
#               1 path) If Company Name is less than two words go down the oriignal script and 2 path) else different script.
#               
