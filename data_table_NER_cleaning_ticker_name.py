...
#       --note Using the latest version to clean keyword planner searches. 
#           I'm going to be changing the column names to reflect the keyword planner
#           Keeping the $, & - removing the apostrophe. Not moving forward with this file, but save for later.
