...
# Version file: V001-000-009 #    Update with next iteration
...
#
#         --note: We introduced a new function, "output_highest_match" & changed the "process_search_queries" function
#               Next is to incorporate a tuple to send into "output_highest_match".
#               In process_search_query function, created the matches []
#
...
if __name__ == "__main__":
    search_query_file = "data/search_query_word_split_metrics-sp500.csv" #data/search_query_word_split_metrics.csv" #search_queries.csv"  # Path to the CSV file containing search queries
