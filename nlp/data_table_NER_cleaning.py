...
def process_csv(csv_file, columns_to_grab, identifier):
    ...
    cleaned_csv_file = os.path.splitext(csv_file)[0] + identifier + '_cleaned.csv'
...
csv_data = [
    ...
    ('data/tickers_list.csv', ['company'], 'Group7'),   # Specify columns for file3.csv and their identifier
