# sq_keyword_word-split_lookupV001-000-000.py
...
def write_output(output_file, search_query_metrics):
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['Search Query', 'Total Impressions']
...
if __name__ == "__main__":
    reference_file = "data/search_query_word_frequency_kwplanner_stockpicks.csv"  # Path to the CSV file containing the reference table
    search_query_file = "data/stock picks-KeywordStats2024-04-11at08_49_40-download.csv"  # Path to the CSV file containing the search queries
    output_file = "data/search_query_word_split_metrics_kwplanner_stockpicks.csv"  # Output CSV file
...
####### UTILIZE THE BELOW FOR if __name__ loop above ######
