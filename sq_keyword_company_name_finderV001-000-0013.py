...
# Version file: V001-000-0013 #    Update with next iteration
...
#
#         --note: This next version is now seeing a new issue with filtering out the repetitiv words, i.e. loss in context check for < 3 words
#               I'm going to update the script to require a next or a prior check
#               
#               
#               
