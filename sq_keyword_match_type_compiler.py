# file name: sq_keyword_match_type_compiler.py
...
def filter_search_queries(input_file, output_file, threshold):
    ...
    with open(input_file, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            impressions = [int(i.strip()) for i in row['Other Impressions'].split(',')]
...
filter_search_queries('data/search_query_word_split_propn_kwplanner_stockpicks.csv','data/sq_keyword_recommended_match_type_kwplanner_stockpicks.csv', 1000)
